...
QRectF MainshowWidget::textRectF(double radius, int pointSize, double angle)  //表盘数字
{
    QRectF rectF;
...
void MainshowWidget::paintEvent(QPaintEvent *event)  //绘制
{
    Q_UNUSED(event);
    // 时针、分针、秒针位置 - 多边形
...
void MainshowWidget::on_ReturnButton_clicked()
{
    emit display(0);
}
